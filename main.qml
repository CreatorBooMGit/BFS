...
Rectangle {
    ...
    function methodClearLightingVertices()
    {
        MainLogic.clearLightingVertices()
    }

    function methodAddLightingVertex(vertex)
    {
        MainLogic.addLightingVertex(vertex)
    }
    ...
    function methodAddVertex(posX, posY)
    {
        MainLogic.addVertexPos(posX, posY)
    }

    function methodAddEdge(vertexLeft, vertexRight)
    {
        MainLogic.clearAddEdge()
        MainLogic.addEdge(vertexLeft)
        MainLogic.addEdge(vertexRight)
    }
