...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Начальная страница","1. Программное обеспечение","2. Алгоритм","1.1. Старт программы","1.2. Вкладка \"Данные\"","2.1. Описание алгоритма","2.2. Реализация","2.3. Приложение алгоритма","1.2.1. Матрица инцидентности","1.2.2. Матрица смежности","1.2.3. Алгоритм поиска в ширину","Меню приложения ","Система","Проект","Результат","Справка"],
    DREX_NODE_LINKS: ["index.htm","programmnoe_obespechenie.htm","algoritm.htm","start_programmy.htm","1_2__vkladka__dannye_.htm","2_1__opisanie_algoritma.htm","2_2__realizatsiya.htm","2_3__prilozhenie_algoritma.htm","1_2_1__matritsa_intsidentnosti.htm","1_2_2__matritsa_smezhnosti.htm","1_2_3__algoritm_poiska_v_shirinu.htm","menyu_prilozheniya_.htm","sistema.htm","proekt.htm","rezultat.htm","spravka.htm"],
    DREX_NODE_CHILD_START: [1,3,5,8,8,12,12,12,12,12,12,12,16,16,16,16],
    DREX_NODE_CHILD_END: [3,5,8,8,12,12,12,12,12,12,12,16,16,16,16,16],
    DREX_MENU_TYPE: 1,
